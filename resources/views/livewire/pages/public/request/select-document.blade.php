        ...
        <div class="bg-white rounded-xl shadow-xl overflow-hidden">
            ...
            <div class="p-6 sm:p-8">
                ...
                <div>
                    ...
                    <div class="mb-8 p-4 bg-bnhs-blue-50 border border-bnhs-blue-200 rounded-lg">
                        <div class="flex items-center justify-between flex-wrap gap-4">
                            <div class="flex items-center gap-3">
                                <div class="w-10 h-10 bg-bnhs-blue text-white rounded-lg flex items-center justify-center">
                                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                                    </svg>
                                </div>
                                <div>
                                    <p class="text-xs text-bnhs-blue font-semibold uppercase tracking-wider">Selected Document</p>
                            ...
                            <div class="w-full sm:w-32">
                                <x-input-label for="quantity" value="Quantity/Copies" />
                                <x-text-input
                                    type="number"
                    ...
                    <div class="mt-8 flex justify-end">
                        <button
                            ...
                            class="inline-flex items-center justify-center gap-2 px-6 py-3 text-base font-semibold text-white bg-bnhs-blue rounded-lg hover:bg-bnhs-blue-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-bnhs-blue transition disabled:opacity-50 disabled:cursor-not-allowed">
