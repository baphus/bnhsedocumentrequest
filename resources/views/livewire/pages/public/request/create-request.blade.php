            ...
            <div class="p-6 sm:p-8">
                <form wire:submit="save" id="requestForm">
                    ...
                    <div class="mb-8">
                        ...
                        <!-- Important Reminder for Reconstructed Diploma/Report Card -->
                        @if($this->selectedDocument?->name === 'Reconstructed Diploma/Report Card')
                        <div class="mt-4 bg-yellow-50 border-l-4 border-yellow-400 p-4 rounded-r-lg">
                            <div class="flex items-start">
                                ...
                                <div class="ml-3 flex-1">
                                    <h4 class="text-sm font-semibold text-yellow-800 mb-2">Important Reminder</h4>
                                    <div class="text-sm text-yellow-700 space-y-2">
                                        <div>
                                            <p class="font-semibold">For Loss Diploma or Report Card, please bring:</p>
                                            <ol class="list-decimal list-inside ml-4 mt-1 space-y-1">
                                                <li>Affidavit of Loss and Request Letter</li>
                                            </ol>
                                        </div>
                                        <div>
                                            <p class="font-semibold">For Diploma Correction, please bring:</p>
                                            <ol class="list-decimal list-inside ml-4 mt-1 space-y-1">
                                                <li>Certificate of Live Birth (issued by Phil. Statistics Authority);</li>
                                                <li>Affidavit of Discrepancy;</li>
                                                <li>Affidavit of Two (2) Disinterested Persons;</li>
                                            </ol>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <p class="mt-3 text-sm font-medium text-yellow-800">Please bring the necessary requirements to the Registrar's Office.</p>
                        </div>
                        @endif
