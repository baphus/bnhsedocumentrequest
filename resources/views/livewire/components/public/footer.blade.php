            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
                ...
                <div class="col-span-1 md:col-span-2 space-y-6">
                    <div class="flex items-center gap-4">
                        ...
                        <img src="{{ asset('images/logo.png') }}" alt="BNHS Logo" class="h-14 w-auto" />
                        @else
                        <div class="w-12 h-12 bg-bnhs-blue rounded-xl flex items-center justify-center text-white shadow-md">
                ...
                <div class="col-span-1">
                    ...
                    <ul class="space-y-4">
                        <li class="flex items-start gap-3">
                            ...
                            <span class="text-sm text-gray-600">bnhs@deped.gov.ph</span>
                        </li>
                        <li class="flex items-start gap-3">
                            <svg class="w-5 h-5 text-bnhs-blue flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
